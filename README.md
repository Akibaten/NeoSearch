...
If you want to skip to installation and usage feel free. its at the bottom ._.

# Intro
This is a project I have been working on to create a search engine for the indie web site neocities.org
...
I love neocities to death. I am quite dissapointed to say that they do not have a search function on their site.
...
Unforunately such a function does not exist on neocities which is one of the biggest and most
...
A user can search for one keyword (right now of course lol more to come in the future)
the program goes through a bunch of sites it has crawled and gotten data from and selects sites containing that keyword
...
If this interests you, and you would like to continue furthere here is the setup guide below~~~~~
...
if you don't already have Homebrew, MacOS's package manage that does not common packaged with MacOS, this is how you install it:
...
## Build databases
Next you have to generate your own databases, but I promise it is super easy. A more in depth guide and explanation can be found in /data/DATABASE.md
If you aren't interested just run
```
python3 /scripts/init_crawler.py
...
```
python3 /scripts/search.py "keyword you want to search"
```

It will show all sites indexed, show all sites containing that keyword, and then rank them and return search results ^_^
